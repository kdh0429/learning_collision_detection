...
for i=2:size(RawData,1)
    RawData(i,23) = (RawData(i,16)-RawData(i-1,16))*100;
    RawData(i,24) = (RawData(i,17)-RawData(i-1,17))*100;
    RawData(i,25) = (RawData(i,18)-RawData(i-1,18))*100;
    RawData(i,26) = (RawData(i,19)-RawData(i-1,19))*100;
    RawData(i,27) = (RawData(i,20)-RawData(i-1,20))*100;
    RawData(i,28) = (RawData(i,21)-RawData(i-1,21))*100;
    RawData(i,29) = (RawData(i,22)-RawData(i-1,22))*100;
end
